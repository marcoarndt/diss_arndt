...
% Einheitliche Definition von \sym
\newcommand{\sym}[1]{\glsadd{#1}\glslink{#1}{\textcolor{blue}{\ensuremath{\glsentrytext{#1}}}}}
\newcommand{\symsilent}[1]{\ensuremath{\glsentrytext{#1}}}
\newcommand{\symsub}[2]{\glsadd{#1}\glsadd{#2}\glslink{#1}{\textcolor{blue}{\ensuremath{\glsentrytext{#1}_{\glsentrytext{#2}}}}}}
\newcommand{\sympow}[2]{\glsadd{#1}\glsadd{#2}\glslink{#1}{\textcolor{blue}{\ensuremath{\glsentrytext{#1}^{\glsentrytext{#2}}}}}}