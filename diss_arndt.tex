...
\glsxtrnewsymbol[type=formulas, description={Stichprobenumfang / Anzahl der Versuchspunkte}, text={\ensuremath{n}}]{n}{\ensuremath{n}}
...
\glsxtrnewsymbol[type=formulas, description={Fehlerterm-Matrix}, text={\ensuremath{\bm{\epsilon}}}]{Epsilon}{\ensuremath{\bm{\epsilon}}}
...
\glsxtrnewsymbol[type=formulas, description={G-Optimalitätskriterium (Minimierung max. Prädiktionsvarianz)},
    text={\ensuremath{G_{\text{opt}}}}]{G_opt}{\ensuremath{G_{\text{opt}}}}
...
\glsxtrnewsymbol[type=formulas, description={Prädiktionsvarianz an der Stelle $\sym{x}$ (skaliert)}, text={\ensuremath{\nu(\sym{x})}}]{pred_var}{\ensuremath{\nu(\sym{x})}}
