...
\glsxtrnewsymbol[type=formulas,
    description={Abstand der Sternpunkte (Axial Points)},
    text={\ensuremath{\alpha}}
]{alpha_rot}{\ensuremath{\alpha}}
% Hinweis: Wir nutzen 'alpha_rot' als Key, um Konflikte mit dem Signifikanzniveau 'alpha' zu vermeiden.
% Im Text wird trotzdem das Symbol alpha gedruckt.

\glsxtrnewsymbol[type=formulas,
    description={Anzahl der faktoriellen Versuchspunkte},
    text={\ensuremath{n_F}}
]{n_fact}{\ensuremath{n_F}}

\glsxtrnewsymbol[type=formulas,
    description={Anzahl der Zentralpunkte},
    text={\ensuremath{n_0}}
]{n_center}{\ensuremath{n_0}}

\glsxtrnewsymbol[type=formulas,
    description={Anzahl der Sternpunkte},
    text={\ensuremath{n_{\alpha}}}
]{n_star}{\ensuremath{n_{\alpha}}}
