...
\newglossaryentry{idx_O}{type=indices, name={\ensuremath{\text{O}}}, description={Beobachtet (Observed)}}
...
\newglossaryentry{idx_F}{type=indices, name={\ensuremath{\text{F}}}, description={Faktorieller Punkt}}
\newglossaryentry{idx_S}{type=indices, name={\ensuremath{\text{S}}}, description={Sternpunkt}}
\newglossaryentry{idx_D}{type=indices, name={\ensuremath{\text{D}}}, description={Sternpunktabstand CCD}}
\newglossaryentry{idx_C}{type=indices, name={\ensuremath{\text{C}}}, description={Zentralpunkt}}
\newglossaryentry{idx_error}{type=indices, name={\ensuremath{\text{error}}}, description={Fehler 2. Art (Wahrscheinlichkeit für ein falsch-negatives Ergebnis)}}
...
\glsxtrnewsymbol[type=formulas, description={Fraktionsgrad}, text={\ensuremath{p_{\text{f}}}}]{p_f}{\ensuremath{p_{\text{f}}}}
...
% ===========================================================================
\glsxtrnewsymbol[type=formulas, description={A-Optimalitätskriterium (Spur-Minimierung)}, text={\ensuremath{A_{\text{opt}}}}]{A_opt}{\ensuremath{A_{\text{opt}}}}
\glsxtrnewsymbol[type=formulas, description={D-Optimalitätskriterium (Determinanten-Maximierung)}, text={\ensuremath{D_{\text{opt}}}}]{D_opt}{\ensuremath{D_{\text{opt}}}}
\glsxtrnewsymbol[type=formulas, description={D-Effizienz (Normierte Determinante)}, text={\ensuremath{D_{\text{eff}}}}]{eff_D}{\ensuremath{D_{\text{eff}}}}
\glsxtrnewsymbol[type=formulas, description={G-Effizienz (Verhältnis Modellparameter zu max. Varianz)}, text={\ensuremath{G_{\text{eff}}}}]{eff_G}{\ensuremath{G_{\text{eff}}}}
\glsxtrnewsymbol[type=formulas, description={E-Optimalitätskriterium (Eigenwert-Minimierung)}, text={\ensuremath{E_{\text{opt}}}}]{E_opt}{\ensuremath{E_{\text{opt}}}}
\glsxtrnewsymbol[type=formulas, description={G-Optimalitätskriterium (Minimierung max. Prädiktionsvarianz)}, text={\ensuremath{G_{\text{opt}}}}]{G_opt}{\ensuremath{G_{\text{opt}}}}
\glsxtrnewsymbol[type=formulas, description={I-Optimalitätskriterium (Minimierung durchschn. Prädiktionsvarianz)}, text={\ensuremath{I_{\text{opt}}}}]{I_opt}{\ensuremath{I_{\text{opt}}}}
\glsxtrnewsymbol[type=formulas, description={S-Optimalitätskriterium (Abstands-Maximierung)}, text={\ensuremath{S_{\text{opt}}}}]{S_opt}{\ensuremath{S_{\text{opt}}}}
\glsxtrnewsymbol[type=formulas, description={V-Optimalitätskriterium (Punktuelle Varianz-Minimierung)}, text={\ensuremath{V_{\text{opt}}}}]{V_opt}{\ensuremath{V_{\text{opt}}}}

% ===========================================================================
% 6. STATISTISCHE KENNZAHLEN & AKRONYME
% ===========================================================================
\glsxtrnewsymbol[type=formulas, description={Einflussstatistik auf Schätzwerte (Covariance Ratio)}, text={\text{COVRATIO}}]{covratio}{\ensuremath{\text{COVRATIO}}}
\glsxtrnewsymbol[type=formulas, description={Einflussstatistik auf Koeffizienten (Difference in Betas)}, text={\text{DFBETAS}}]{dfbetas}{\ensuremath{\text{DFBETAS}}}
\glsxtrnewsymbol[type=formulas, description={Einflussstatistik auf Prädiktionen (Difference in Fits)}, text={\text{DFFITS}}]{dffits}{\ensuremath{\text{DFFITS}}}
\glsxtrnewsymbol[type=formulas, description={Erwartete Testdauer}, text={\text{ETD}}]{ETD}{\ensuremath{\text{ETD}}}
