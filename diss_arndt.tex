...
\examiner{PD~Dr.-Ing.~Martin Dazer}
...
% --- Neue Indizes für Parametervektoren ---
\newglossaryentry{j}{type=indices, name={\ensuremath{j}}, description={Laufvariable (Parameter-Index)}}
\newglossaryentry{l}{type=indices, name={\ensuremath{l}}, description={Laufvariable (Parameter-Index)}}
...
\glsxtrnewsymbol[type=formulas, description={Integrationsvariable (Gamma-Funktion)}, text={\ensuremath{z}}]{z}{\ensuremath{z}}

\glsxtrnewsymbol[type=formulas,
    description={Fisher-Informationsmatrix},
    text={\ensuremath{\mathcal{I}}}
]{FIM}{\ensuremath{\mathcal{I}}}

\glsxtrnewsymbol[type=formulas,
    description={Beobachtete Fisher-Informationsmatrix},
    text={\ensuremath{\mathcal{I}_O}}
]{FIM_O}{\ensuremath{\mathcal{I}_O}}

\glsxtrnewsymbol[type=formulas,
    description={Hessian-Matrix (der Log-Likelihood-Funktion)},
    text={\ensuremath{\mathbf{H}}}
]{H}{\ensuremath{\mathbf{H}}}

\glsxtrnewsymbol[type=formulas,
    description={Varianz-Kovarianz-Matrix (geschätzt)},
    text={\ensuremath{\hat{\Sigma}}}
]{Sigma_hat}{\ensuremath{\hat{\Sigma}}}

\glsxtrnewsymbol[type=formulas,
    description={Standardfehler (Standard Error)},
    text={\ensuremath{\mathit{se}}}
]{se}{\ensuremath{\mathit{se}}}

\glsxtrnewsymbol[type=formulas,
    description={Signifikanzniveau},
    text={\ensuremath{\alpha}}
]{alpha}{\ensuremath{\alpha}}

% \glsxtrnewsymbol[type=formulas,
%     description={Quantil der Standardnormalverteilung},
%     text={\ensuremath{z}}
% ]{z}{\ensuremath{z}}
