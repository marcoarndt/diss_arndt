...
\newacronym[plural=MLEs, longplural=Electronic Control Units]{MLE}{MLE}{Maximum-Likelihood-Estimation/-Estimates}
...
\glsxtrnewsymbol[type=formulas, description={Zeit, Lebensdauermerkmal}]{t}{\ensuremath{t}}
...
\glsxtrnewsymbol[type=formulas, description={Messwert}, text={\ensuremath{x}}]{x}{\ensuremath{x}}
...
\glsxtrnewsymbol[type=formulas, description={Varianz-Operator}, text={\ensuremath{\text{Var}}}]{Var}{\ensuremath{\text{Var}[\cdot]}}
...
\glsxtrnewsymbol[type=formulas, description={Log-Likelihood-Funktion}, text={\ensuremath{\Lambda}}]{Lambda}{\ensuremath{\mathcal{\Lambda}(\cdot)}}
\glsxtrnewsymbol[type=formulas, description={Vektor der Modellparameter}, text={\ensuremath{\theta}}]{theta}{\ensuremath{\theta}}
...
%     description={Vektor der geschätzten Modellparameter (MLE-Schätzer)},
%     text={\ensuremath{\hat{\Theta}}}
% ]{Theta_hat}{\ensuremath{\hat{\Theta}}}
