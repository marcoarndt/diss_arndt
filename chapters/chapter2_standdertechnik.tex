...
\begin{table}[htbp]
    ...
    \end{tabular}
\end{table}
Eine Übersicht verschiedener Modellierungsansätze (z.B. Arrhenius, Inverses Potenzgesetz, etc.) und deren Einbindung in die \ac{GLM}-Struktur findet sich in den Arbeiten von \textcite{Meeker.2022,Rigdon.2022,Modarres.2017}.
...
\end{equation}
Ist das Modell korrekt spezifiziert, müssen diese Residuen (unter Berücksichtigung der Zensierung) einer Verteilung der kleinsten Extremwerte $\sym{SEV}\left(\sym{mu}=0,\sym{sigma}=1\right)$ folgen.
