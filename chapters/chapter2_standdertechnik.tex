...
Ein \ac{CCD} entsteht durch die Augmentierung des ursprünglichen voll- (oder teil-)faktoriellen Plans (den $\symsub{n}{idx_F}$ Eckpunkten) um:
\begin{itemize}
...
Ihr Einsatz ist prädestiniert für Szenarien, in denen klassische orthogonale Pläne an ihre Grenzen stoßen - sei es durch physikalische Constraints welche bestimmte Faktorstufenkombinationen ausschließen, oder durch strikte Limitierungen der verfügbaren Versuchskapazität.
...
Eine Übersicht dieser Optimalitätskriterien, welche den quantitativen Vergleich zur Standard-Methodik ermöglichen, ist in Tabelle~\ref{tab:2.1_optimalitäten} zusammengefasst \cite{Goos.2011,Montgomery.2020}.
\begin{table}[htbp]
    \centering
    ...
    \begin{tabular}{@{}lp{0.75\textwidth}@{}}
        ...
        \textit{Beste Gesamtschätzung aller Parameter; maximiert die Determinante der Informationsmatrix} \\
        \addlinespace
        ...
        \textit{Optimale Vorhersage-Güte im Mittel; ideal für RSM}                                        \\
        \addlinespace
