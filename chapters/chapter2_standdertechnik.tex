...
Der \textbf{Ausfall}, engl. \textbf{\ac{EoL}}, eines Produkts bezeichnet das Ende der Lebensdauer durch Verlust der geforderten Funktionalität.
Maßgeblich hierfür sind von außen einwirkende \textbf{Belastungen} (\textit{einzelne} oder zeitgleich \textit{mehrere} Einflussparameter - Kräfte und Momente im mechanischen Kontext) sowie die daraus resultierenden inneren \textbf{Beanspruchungen} (innere Kräfte, Momente und lokale Spannungen).
...
\begin{longtable}{@{} p{\textwidth} @{}}
    ...
    \textbf{Zuverlässigkeit} (engl. Reliability): \newline
...
Tabelle~\ref{tab:deskriptive_statistik} fasst die theoretischen Definitionen der Zufallsvariable $\sym{tau}$ sowie die grundlegenden Zuverlässigkeitsfunktionen und ihre korrespondierenden empirischen Schätzer kompakt zusammen.
    {
        ...
        \begin{longtable}{@{} p{\textwidth} @{}}
            ...
            Erwartungswert $\sym{mu}$ des theoretischen Lageparameters der Grundgesamtheit. Der arithmetische Mittelwert $\sym{x_bar}$ dient als üblicher, \textbf{empirischer Schätzer} für eine endliche Stichprobe.
