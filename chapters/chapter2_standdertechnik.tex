...
Während der $\sym{A2}$-Indikator die Gesamtmatrix bewertet, stehen die Diagonalelemente der Matrix $(\sym{X}'\sym{X})^{-1}$ in direktem Zusammenhang mit dem \textbf{\ac{VIF}} für die Evaluation einzelner Modellterme \cite{Siebertz.2017,Kleppmann.2020}.
