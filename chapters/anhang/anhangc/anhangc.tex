...
\begin{figure}[htbp]
    ...
    \caption{Zusammenhang zwischen simulierter Schätzvarianz (\ac{MSE}) und dem prozentualen Trennschärfe-Verlust ($\Delta \sym{power}$) über alle Koeffizienten und Szenarien. Die Pearson-Korrelation $\sym{corr}$ untermauert die signifikante Kausalität.}
